...
export function Sidebar() {
  ...
  return (
    <aside className={`${isCollapsed ? 'w-[60px]' : 'w-[220px]'} transition-all duration-300 flex-shrink-0 h-full flex flex-col border-r border-mist bg-sand dark:bg-charcoal dark:border-stone`}>
      {/* Header */}
      <div className="flex items-center justify-between px-5 pt-6 pb-4">
        {!isCollapsed && (
          <span className="text-[11px] font-mono font-semibold tracking-widest uppercase text-shadow dark:text-fog">
            Notes
          </span>
        )}
